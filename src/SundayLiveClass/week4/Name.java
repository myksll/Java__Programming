...
Name [Scanner, String methods]
	...
	Create a program that will ask the user to enter their name.
	The name should be accepted as ().
	The program will not be able to handle any other format

	Take the name and do two things:
		1) Print the name in correct formatting meaning the first letter of the first name
		and last name would be uppercase and the rest will be lowercase
