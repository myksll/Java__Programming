    ...
    public static void main(String[] args) {
        ...
        if (peopleNum >= 1 && peopleNum <= 6) {
            ...
            if (peopleNum == 1) {
                ...
                roomType = "A large room";
                price = daysNum * peopleNum * 50;

            } else {
                roomType = "A suite";
                price = daysNum * 1000;
            }
            System.out.println("You are assigned to a " + roomType + " for days " + daysNum + " so your total comes to $" + price);

        }else{

            System.out.println("sorry "+ peopleNum +" is not a valid group size");
        }
    }
}
/*
...
Hotel [scanner, conditional, operators]
	...
	Create a program that will allow you to check into a hotel.
