...
public class PolymorphismPractice3 {
    ...
    public static void main(String[] args) {
        ...
        Employee[] employees = {
                ...
                new Teacher("James",29,'M',  "B1", "Math Teacher", 75000),
        ...
        //1. Print the name and Job Title of every employee-->for each loop
 ...
 */
        ...
        for (Employee each : employees) {
            ...
            if(each instanceof Developer){ //if the employee is developer
                countDeveloper++;
            }else if(each instanceof Developer){  //if the employee is tester
                countTester++;
   ...
   //6. Display the names of employees who are not developers
        ...
        System.out.println("the names of employees who are not developers: " );
