...
public class CydeoLogIn {
    ...
    public static void main(String[] args) {
        ...
        if(userName.equals("Cydeo")&& password.equals("WoodenSpoon")){  //if the credentials are valid/correct
            System.out.println("Logged in");
        }else{  //otherwise

            for (int i = 0; i < 3; i++) { // i : 0 1 2

                /*  //  if we warn at the last attempt

                if( i !=2 ){
                    System.err.println("Incorrect username or password, please re-enter");
                }else{
                    System.err.println("This is your last attempt, please re-enter username and password");
                }
                */
                ...
                if( ! (userName.equals("Cydeo") && password.equals("WoodenSpoon"))){ //after all three attempts , if the username or password are still incorrect
