...
public class MapPractice3 {
    public static void main(String[] args) {
        ...
        //we will store these objects by using Collection/Array

        Map<String,Object>[] arrayOfMap =new Map[5];//5 map object //index number=0~4
        ...
        //arrayOfMap[5] = new LinkedHashMap<>(); array size is fixed

        //update the information of second employee's salary by increasing 100000

        arrayOfMap[1].replace("salary",((Integer)arrayOfMap[1].get("salary")+10000));

        //change the name from Artur to Hassan

        arrayOfMap[0].replace("name","Hassan");
        ...
        for (Map<String, Object> eachMap : arrayOfMap) {
           // System.out.println(eachMap);
            for (Map.Entry<String, Object> eachEntry : eachMap.entrySet()) { //now we can get  each salary
