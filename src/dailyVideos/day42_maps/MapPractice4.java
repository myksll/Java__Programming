...
import practices.day29_practices.employeeTask.Developer;
...
public class MapPractice4 {
    public static void main(String[] args) {
        ...
        System.out.println("------------------------------------------------------------------------------------------");
               //key                   value
        Map<   Map<String, Integer> , Map<String , Integer>> mapOfMaps2 = new LinkedHashMap<>(); //it can get slow your code

        Map<int [] , List<Integer>>  map2 =new LinkedHashMap<>(); //Array(array supports primitive , but it is an object) - List

        Map<Developer, Car> map3 =new LinkedHashMap<>();   //map supports all non primitives array, list, custom class, collections. map accepts object
